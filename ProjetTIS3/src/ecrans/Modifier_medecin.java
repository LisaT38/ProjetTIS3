 ...
 */
public class Modifier_medecin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modifier Informations Medecin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modifier_medecin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modifier_medecin().setVisible(true);
            }
        });
    }
