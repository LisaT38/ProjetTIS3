...
class FicheDeSoins {
    ...
    public void ajouterActe(Code code, int coefficient, TypeActe type, String observations) {
        Acte acte = new Acte(code, coefficient, type, observations);
        actes.add(acte);
    }
    
    public void afficherActes(){
        for(Acte a : actes){
